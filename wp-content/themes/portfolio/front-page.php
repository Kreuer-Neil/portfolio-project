...
<h1 class="home-title">
    <svg class="home-title__logo" title="Neil Kreuer" alt="Neil Kreuer"
...
<section class="about" id="about">
    ...
    <div class="about__container">
        ...
        <article class="about__item">
            ...
            <p class="about__content">Je suis un dev plutôt axé back-end, qui sait assez bien visualiser en avance les possibilités avec le code, avec des idées en design manquant d’organisation.</p>
        </article>
        <article class="about__item">
            ...
            <p>Figma est un outil que j’admire. J’utilise tous les jours son auto layout, et l’application dispose de tellement de fonctionnalités que même mes SVG se font par là. Ses composants, variables et différents modes permettent de simuler presque entièrement tout le comportement d’une web app.
                Par ailleurs, c’est Figma qui m’aide à préparer mon CSS.</p>
        </article>
        <article class="about__item">
            <?php /* <h2 class="about__title--specs"><?= get_field('specialities_title') ?></h2>
                    <p class="about__content--specs"><?= get_field('specialities_content')?></p> */ ?>
            <h3 class="about__title">Laravel/Livewire</h3>
            <p>Ma meilleure expérience de création de webapp avec du PHP restera via le framework Laravel, voir même LiveWire. Le gain de temps titanesque que représente l’utilisation de ces frameworks est incroyable.</p>
        </article>
    </div>
